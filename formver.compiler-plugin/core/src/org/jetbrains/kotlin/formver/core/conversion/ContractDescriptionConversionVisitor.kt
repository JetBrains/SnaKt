...
class ContractDescriptionConversionVisitor(
    ...
    override fun visitIsNullPredicate(
        ...
        val role = SourceRole.Condition.IsNull(isNullPredicate.arg.getTargetParameter(), isNullPredicate.isNegated)
    ...
    override fun visitIsInstancePredicate(
        ...
        val argSymbol = isInstancePredicate.arg.getTargetParameter()

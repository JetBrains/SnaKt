...
class DebugTreeViewVisitor(private val nameResolver: NameResolver) : ExpVisitor<TreeView> {
    ...
    override fun visitSize(e: Size): TreeView = with(nameResolver) {
        defaultTree("Size", extraSubtrees = listOf(e.exp.debugTreeView))
    }

    override fun visitSeqLookup(e: SeqLookup): TreeView = with(nameResolver) {

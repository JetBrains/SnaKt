...
data class ExpWrapper(val value: Exp, override val type: TypeEmbedding) : ExpEmbedding {
    ...
    override val debugTreeView: TreeView
        get() = PlaintextLeaf(javaClass.simpleName)
}

data object ErrorExp : ExpEmbedding, DefaultDebugTreeViewImplementation {
...
data class Assert(val exp: ExpEmbedding) : ExpEmbedding, DefaultDebugTreeViewImplementation {
 ...
 */
data class InhaleDirect(val exp: ExpEmbedding) : ExpEmbedding, DefaultDebugTreeViewImplementation {
    override val type: TypeEmbedding = buildType { unit() }

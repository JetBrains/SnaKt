...
object LinearizationVisitor : ExpVisitor<Linearizable> {
    ...
    override fun visitIf(e: If): Linearizable = object : OptionalResultLinearizable(e) {
        override fun toViperMaybeStoringIn(result: VariableEmbedding?, ctx: LinearizationContext) {
            ctx.addBranch(e.condition, e.thenBranch, e.elseBranch, e.type, result)
        }
    }
    ...
    override fun visitGoto(e: Goto): Linearizable = object : NoResultLinearizable(e) {
    ...
    override fun visitFunctionCall(e: FunctionCall): Linearizable = object : DirectResultLinearizable(e) {
    ...
    override fun visitInvokeFunctionObject(e: InvokeFunctionObject): Linearizable = object : DirectResultLinearizable(e) {
    ...
    override fun visitElvis(e: Elvis): Linearizable = object : StoredResultLinearizable(e) {
        override fun toViperStoringIn(result: VariableEmbedding, ctx: LinearizationContext) {
            ...
            val conditional = If(leftWrapped.notNullCmp(), leftWrapped, e.right, e.type)
    ...
    override fun visitReturn(e: Return): Linearizable = object : OptionalResultLinearizable(e) {
        override fun toViperMaybeStoringIn(result: VariableEmbedding?, ctx: LinearizationContext) {
            ctx.addReturn(e.returnExp, e.target)
        }
    }
    ...
    override fun visitLiteralEmbedding(e: LiteralEmbedding): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
    ...
    override fun visitVariableEmbedding(e: VariableEmbedding): Linearizable = object : DirectResultLinearizable(e) {
    ...
    override fun visitExpWrapper(e: ExpWrapper): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp = e.value
    }

    override fun visitErrorExp(e: ErrorExp): Linearizable = object : NoResultLinearizable(e) {
        override fun toViperUnusedResult(ctx: LinearizationContext) {
    ...
    override fun visitIs(e: Is): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
    ...
    override fun visitCast(e: Cast): Linearizable = object : DirectResultLinearizable(e) {
    ...
    override fun visitSafeCast(e: SafeCast): Linearizable = object : StoredResultLinearizable(e) {
        override fun toViperStoringIn(result: VariableEmbedding, ctx: LinearizationContext) {
            ...
            val conditional = If(Is(expWrapped, e.targetType), expWrapped, NullLit, e.type)
            conditional.linearize().toViperStoringIn(result, ctx)
        }
    }
    ...
    override fun visitInhaleInvariants(e: InhaleInvariants): Linearizable {
        ...
        if (e.exp.underlyingVariable != null) {
            return object : DirectResultLinearizable(e) {
                override fun toViper(ctx: LinearizationContext): Exp {
    ...
    override fun visitBinaryOperatorExpEmbedding(e: BinaryOperatorExpEmbedding): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
            e.refsOperation(
    ...
    override fun visitUnaryOperatorExpEmbedding(e: UnaryOperatorExpEmbedding): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
    ...
    private fun sequentialLogicOperator(e: SequentialLogicOperatorEmbedding): Linearizable = object : DirectResultLinearizable(e) {
    ...
    private fun comparisonLinearizable(e: AnyComparisonExpression): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
            RuntimeTypeDomain.boolInjection.toRef(
    ...
    override fun visitOld(e: Old): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
    ...
    override fun visitPrimitiveFieldAccess(e: PrimitiveFieldAccess): Linearizable = object : DirectResultLinearizable(e) {
        override fun toViper(ctx: LinearizationContext): Exp =
    ...
    override fun visitFieldAccess(e: FieldAccess): Linearizable = object : Linearizable {
        override fun toViper(ctx: LinearizationContext): Exp {
            ...
            return ctx.addFieldAccess(e)
        }

        override fun toViperStoringIn(result: VariableEmbedding, ctx: LinearizationContext) {
            ctx.addFieldAccessStoringIn(e, result)
        }
        ...
        override fun toViperBuiltinType(ctx: LinearizationContext): Exp =
            defaultToViperBuiltinType(::toViper, e, ctx)
        ...
        override fun toViperSideEffects(ctx: LinearizationContext) {
            when (e.field.accessPolicy) {
                AccessPolicy.BY_RECEIVER_UNIQUENESS -> {
                    ...
                    val newValueViper = e.newValue.withType(e.field.type).linearize().toViper(ctx)
                    ctx.addStatement {
                        Stmt.FieldAssign(
    ...
    override fun visitFieldAccessPermissions(e: FieldAccessPermissions): Linearizable = object : OnlyToBuiltinLinearizable(e) {
        override fun toViperBuiltinType(ctx: LinearizationContext): Exp =
            e.inner.linearize().toViper(ctx).fieldAccessPredicate(e.field.toViper(), e.perm, ctx.source.asPosition)
    }

    override fun visitPredicateAccessPermissions(e: PredicateAccessPermissions): Linearizable = object : OnlyToBuiltinLinearizable(e) {
        override fun toViperBuiltinType(ctx: LinearizationContext): Exp =
    ...
    override fun visitAssign(e: Assign): Linearizable = object : UnitResultLinearizable(e) {
        override fun toViperSideEffects(ctx: LinearizationContext) {
            e.rhs.withType(e.lhs.type).linearize().toViperStoringIn(LinearizationVariableEmbedding(e.lhs.name, e.lhs.type), ctx)
        }
    }
    ...
    override fun visitDeclare(e: Declare): Linearizable = object : UnitResultLinearizable(e) {
        override fun toViperSideEffects(ctx: LinearizationContext) {
            ...
            e.initializer?.withType(e.variable.type)
    ...
    override fun visitForAllEmbedding(e: ForAllEmbedding): Linearizable = object : OnlyToBuiltinLinearizable(e) {
        override fun toViperBuiltinType(ctx: LinearizationContext): Exp {
            val conjunction = with(Exp) { e.subexpressions.map { it.linearize().toViperBuiltinType(ctx) }.toConjunction() }
            ...
            return Exp.Forall(
                ...
                exp = if (e.variable.isOriginallyRef) Exp.Implies(
                    e.variable.linearize().toViper(ctx).isOf(e.variable.type.runtimeType),
                    conjunction
                )
                else conjunction,
                pos = ctx.source.asPosition,
    ...
    override fun visitAccEmbedding(e: AccEmbedding): Linearizable = object : OnlyToBuiltinLinearizable(e) {
        override fun toViperBuiltinType(ctx: LinearizationContext): Exp {
    ...
    override fun visitWithPosition(e: WithPosition): Linearizable = object : Linearizable {
        override fun toViper(ctx: LinearizationContext): Exp =
            ctx.withPosition(e.source) { e.inner.linearize().toViper(this) }

        override fun toViperStoringIn(result: VariableEmbedding, ctx: LinearizationContext) {
            ctx.withPosition(e.source) { e.inner.linearize().toViperStoringIn(result, this) }
        }

        override fun toViperMaybeStoringIn(result: VariableEmbedding?, ctx: LinearizationContext) {
            ctx.withPosition(e.source) { e.inner.linearize().toViperMaybeStoringIn(result, this) }
        }

        override fun toViperBuiltinType(ctx: LinearizationContext): Exp =
            ctx.withPosition(e.source) { e.inner.linearize().toViperBuiltinType(this) }

        override fun toViperUnusedResult(ctx: LinearizationContext) {
            ctx.withPosition(e.source) { e.inner.linearize().toViperUnusedResult(this) }
        }
    }
    ...
    override fun visitShared(e: Shared): Linearizable = object : StoredResultLinearizable(e) {
        ...
        override fun toViperStoringIn(result: VariableEmbedding, ctx: LinearizationContext) {
            e.context.tryInitShared { e.inner.linearize().toViperStoringIn(result, ctx); result.linearize().toViper(ctx) }
        }

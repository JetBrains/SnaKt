...
internal class ExprPurityVisitor(val declaredVariables: MutableSet<VariableEmbedding> = mutableSetOf()) :
    ...
    override fun visitAdtConstructorRef(e: AdtConstructorRef) = true // will be updated for arguments soon
    ...
    override fun visitSize(e: Size): Boolean = e.allChildrenPure(this)
    override fun visitSeqLookup(e: SeqLookup): Boolean = e.allChildrenPure(this)

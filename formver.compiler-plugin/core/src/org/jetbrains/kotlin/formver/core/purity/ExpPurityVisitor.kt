...
internal class ExprPurityVisitor(val declaredVariables: MutableSet<VariableEmbedding> = mutableSetOf()) :
    ...
    override fun visitIntArrayGet(e: IntArrayGet): Boolean = e.allChildrenPure(this)
    override fun visitIntArraySize(e: IntArraySize): Boolean = e.allChildrenPure(this)
    override fun visitIntArrayToMultiset(e: IntArrayToMultiset): Boolean = e.allChildrenPure(this)

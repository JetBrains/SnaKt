...
- Committed the focused tests, generated goldens and registration, instruction record, and diary on `test/issue-349-early-returns` with the required Air signature; pushed the branch and opened pull request #409 against `implementing-air-automations`.
